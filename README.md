...
You are able to use podman/docker inside the container by passing the outer docker socket through to the container: ˋdocker run --rm -it --privileged -v /var/run/docker.sock:/var/run/docker.sock workbenchˋ
