...
function miscelanious_install() {
  ...
  $USE_SUDO apt install -y duf gdu dos2unix dropbear zoxide htop iotop bind9-dnsutils net-tools tree lsd sqlite3 apache2-utils # apache2-utils => needed for htpasswd for argocd bcrypt
